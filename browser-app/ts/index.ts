...
class Application {
  ...
  start() {
    ...
    this.eventListener.add('submit', createForm, this.handleSubmit, 'submit-handler')
    this.eventListener.add('click', deleteAllDoneTaskButton, this.handleClickDeleteAllDoneTasks, 'click-handler')
